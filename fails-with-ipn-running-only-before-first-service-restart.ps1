...
Write-Host -ForegroundColor Green "Restarting the tailscale service for the first time, and killing tailscale-ipn.exe along the way."
sleep $sleepTime
net stop Tailscale
sleep $sleepTime
...
Write-Host -ForegroundColor Green "Restarting the tailscale service a second time."
sleep $sleepTime
net stop Tailscale
sleep $sleepTime
net start Tailscale
